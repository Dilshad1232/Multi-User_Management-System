...
@section('title', 'MUMS - Admin Profile')
@section('content')
    ...
    <div class="profile-container mx-auto shadow-lg rounded-4 overflow-hidden">
        ...
        <div class="profile-sidebar text-center">
            <div class="sidebar-photo mx-auto">
                <img src="{{ $user->profile_photo ? asset('admin_profile/' . $user->profile_photo) : asset('img/default-user.jpg') }}" alt="Profile Photo">
            </div>
            <div class="sidebar-name mt-3 text-uppercase">{{ $user->full_name }}   <br>[ Admin ]</div>
            ...
            <div class="sidebar-role">Role : [ {{ $user->role ?? 'Admin' }} ]</div>
        ...
        <div class="profile-details">
            <h2 class="border-bottom border-secondary pb-2 mb-4 text-warning">Admin Information</h2>
            ...
            <div class="buttons mt-4">
                <a href="#" class="edit-btn text-center text-decoration-none">Edit Profile</a>
