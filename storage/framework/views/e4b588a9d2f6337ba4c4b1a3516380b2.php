    ...
    <div class="profile-container mx-auto shadow-lg rounded-4 overflow-hidden">
        ...
        <div class="profile-sidebar text-center">
            <div class="sidebar-photo mx-auto">
                <img src="<?php echo e($user->profile_photo ? asset('profiles/' . $user->profile_photo) : asset('img/default-user.jpg')); ?>" alt="Profile Photo">
            </div>
        ...
        <div class="profile-details">
            ...
            <div class="profile-info">
                <div><b>Father's Name:</b> <?php echo e($user->father_name ?? 'N/A'); ?></div>
                <div><b>Mobile No.:</b> <?php echo e($user->mobile_no ?? 'N/A'); ?></div>
                <div><b>Email:</b> <?php echo e($user->email); ?></div>
                <div><b>Address:</b> <?php echo e($user->address ?? 'N/A'); ?></div>
                <div><b>District:</b> <?php echo e($user->district ?? 'N/A'); ?></div>
                <div><b>Pin Code:</b> <?php echo e($user->pin_code ?? 'N/A'); ?></div>
            </div>

            <div class="buttons mt-4">
                <a href="<?php echo e(route('user.profile.edit')); ?>" class="edit-btn text-center text-decoration-none">Edit Profile</a>
...
<?php echo $__env->make('user.dashboard.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laravel all\myapp\resources\views/user/profile.blade.php ENDPATH**/ ?>