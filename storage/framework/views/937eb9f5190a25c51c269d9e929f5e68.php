...
<div class="login-wrapper ">
    <div class="login-box mt-5 ">
        ...
        <form method="POST" action="<?php echo e(url('/login')); ?>" class="mt-3">
            <?php echo csrf_field(); ?>
        ...
        <p class="text-small mt-3">
            ...
            <a href="<?php echo e(url('/register')); ?>" class="text-warning text-decoration-none fw-bold">Register</a>
        </p>
    </div>
</div>
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laravel all\myapp\resources\views/auth/login.blade.php ENDPATH**/ ?>